...
public class Book extends Publication implements IVisualizable {
	...
	public void view() {
		...
		do {
			System.out.println("..................");
			System.out.println("Page " + getPage().get(i).getNumber());
			System.out.println(getPage().get(i).getContent());
			System.out.println("..................");
			if (i != 0) {
	...
	public void setPage(ArrayList<Page> pages) {
		this.pages = pages;
	}
